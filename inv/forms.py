...
class UMForm(forms.ModelForm):
    class Meta:
        model=UnidadMedida
        fields=['descripcion','estado']
        labels={'descripcion':"Descripcion de la Medida",
                "estado":"Estado"}
        widget={'descripcion':forms.TextInput()}
...
class precisionForm(forms.ModelForm):
    class Meta:
        model=historiareporte
        fields=['descripcion','total','diferencias','porcentaje']
        labels={'descripcion':"nombre de historia",
        'total':"total",
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['diferencias'].widget.attrs['readonly']=True
